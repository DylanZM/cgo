...
export default function SettingsPanel({ settings, onUpdate, onClose, closing }: SettingsPanelProps) {
  ...
  return (
    <div
      className={`${closing ? 'settings-panel-out' : 'settings-panel'} h-full flex flex-col border-l border-border w-full relative transition-colors duration-300 ease-out`}
      style={{
